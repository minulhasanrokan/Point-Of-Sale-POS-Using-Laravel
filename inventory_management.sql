...
--
-- Host: localhost
-- Generation Time: Aug 13, 2022 at 04:19 PM
...
CREATE TABLE `advanced_salaries` (
  ...
  `advance_salary` int(255) DEFAULT NULL,
  `month` int(255) NOT NULL,
  `year` int(255) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `salary_status` tinyint(1) NOT NULL DEFAULT 1,
...
CREATE TABLE `attendances` (
  ...
  `edit_date` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `categories` (
  ...
  `cat_des` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `create_employes_tables`
--

CREATE TABLE `create_employes_tables` (
  `id` int(10) UNSIGNED NOT NULL,
...
(6, '2022_06_13_163500_create_sessions_table', 1),
(7, '2022_06_21_155332_create_create_employes_tables_table', 1),
(8, '2022_07_03_180955_create_customers_table', 1),
(9, '2022_07_17_180352_create_suppliers_table', 1),
(10, '2022_07_20_164227_create_salaries_table', 1),
(11, '2022_07_25_202151_create_categories_table', 2),
(12, '2022_07_27_174446_create_products_table', 3),
(13, '2022_07_29_165641_create_expenses_table', 4),
(14, '2022_07_30_182349_create_attendances_table', 5),
(15, '2022_08_02_062444_create_settings_table', 6),
(16, '2022_08_10_173003_create_orders_table', 7),
(17, '2022_08_10_173018_create_order_details_table', 7);
...
CREATE TABLE `order_details` (
  ...
  `total` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `order_details_status` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `settings` (`id`, `name`, `email`, `phone`, `mobile`, `address`, `city`, `country`, `zip_code`, `logo`, `created_at`, `updated_at`) VALUES
(1, 'ABC Traders', 'minulhasanrokan@gmail.com', '+8801627197089', '+8801627197089', 'Dhaka', 'Dhaka', 'bangladesh', '1216', 'abc_1659464980.jpg', NULL, NULL);
...
--
-- Indexes for table `create_employes_tables`
--
ALTER TABLE `create_employes_tables`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `create_employes_tables`
--
ALTER TABLE `create_employes_tables`
