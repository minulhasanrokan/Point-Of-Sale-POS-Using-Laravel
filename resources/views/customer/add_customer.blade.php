    ...
    <div class="col-xl-6 ">
        <div class="card">
            <div class="card-header">
                <h3 style="display: inline-block;margin-top:10px ;" class="card-title">Add Customer</h3>
                <a style="width: 200px; float: right; display: inline-block;" href="{{route('all.customer')}}" type="button" class="btn btn-icon waves-effect waves-light btn-primary">
                    Manage Customer
                </a>
            </div>
            @if ($errors->any())
            ...
            <div class="card-body">
                <form method="post" role="form" action="{{url('/insert-customer')}}" enctype="multipart/form-data">
                    ...
                    <button id="add_new_Customer" type="submit" class="btn btn-purple waves-effect waves-light">Submit</button>
                </form>
            </div>
            <!-- card-body -->
        </div>
