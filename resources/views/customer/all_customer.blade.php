    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <a style="width: 200px; float: right; display: inline-block;" href="{{route('add.customer')}}" type="button" class="btn btn-icon waves-effect waves-light btn-primary">
                    Add New Customer
                </a>
            </div>
            <div class="card-body">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img style="width: 40px; height: 40px;" src="customer/{{$row->photo}}"></td>
                            <td>{{$row->name}}</td>
                            <td>{{$row->phone}}</td>
                            <td>{{$row->address}}</td>
                            <td>{{$row->city}}</td>
                            ...
                            <td>
                                <a  href="{{URL::to('change-customer-status/'.$row->id)}}"  type="button" class="change_customer_status btn btn-icon waves-effect waves-light btn-danger">
                                ...
                                <a  href="{{URL::to('delete-customer/'.$row->id)}}"  type="button" class="delete_customer btn btn-icon waves-effect waves-light btn-danger">
                                    <i class="fas fa-times"></i>
                                </a>
                                <a href="{{URL::to('edit-customer/'.$row->id)}}" type="button" class="btn btn-icon waves-effect waves-light btn-warning">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="{{URL::to('view-customer/'.$row->id)}}" id="view_{{$sl}}" type="button" class="btn btn-icon waves-effect waves-light btn-primary">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>
