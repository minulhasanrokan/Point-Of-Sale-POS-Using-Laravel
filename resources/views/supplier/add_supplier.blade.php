    ...
    <div class="col-xl-6 ">
        <div class="card">
            <div class="card-header">
                ...
                <a style="width: 200px; float: right; display: inline-block;" href="{{route('all.supplier')}}" type="button" class="btn btn-icon waves-effect waves-light btn-primary">
                    manage Supplier
                </a>
            </div>
            @if ($errors->any())
            ...
            @endif
            <div class="card-body">
                <form method="post" role="form" action="{{url('/insert-Supplier')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter Supplier Phone" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shop" class="form-control" id="shop" placeholder="Enter Supplier Shop Name" required>
                    </div>
                    <div class="form-group">
                        <label>Supplier NID NO</label>
                        <input type="text" name="nid_no" class="form-control" id="nid_no" placeholder="Enter Supplier NID NO" required>
                    </div>
                    <div class="form-group">
                        <label>Supplier City</label>
                        <input type="text" name="city" class="form-control" id="city" placeholder="Enter Supplier City" required>
                    </div>
                    <div class="form-group">
