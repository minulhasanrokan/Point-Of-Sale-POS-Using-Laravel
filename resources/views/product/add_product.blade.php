    ...
    <div class="col-xl-6 ">
        <div class="card">
            <div class="card-header">
                <h3 style="display: inline-block;margin-top:10px ;" class="card-title">Add New Product</h3>
                <a style="width: 200px; float: right; display: inline-block;" href="{{route('all.product')}}" type="button" class="btn btn-icon waves-effect waves-light btn-primary">
                    Manage Product
                </a>
            </div>
            @if ($errors->any())
            ...
            <div class="card-body">
                <form method="post" role="form" action="{{url('/insert-product')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product_place" class="form-control" id="product_place" placeholder="Product Godown Number" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="buy_date" class="form-control" id="buy_date" placeholder="Enter Product Buying Date" >
                    </div>
                    <div class="form-group">
                        <label>Product Expire Date</label>
                        <input type="date" name="expire_date" class="form-control" id="expire_date" placeholder="Enter CProduct Expire Date" >
                    </div>
                    <div class="form-group">
                        <label>Product Buying Price</label>
                        <input type="number" name="buying_price" class="form-control" id="buying_price" placeholder="Enter Product Buying Price" >
                    </div>
                    <div class="form-group">
                        <label>Product Saling Price</label>
                        <input type="number" name="sale_price" class="form-control" id="sale_price" placeholder="Enter CProduct Saling Price" >
                    </div>
                    <div class="form-group">
                        <label>Product Description</label>
                        <textarea name="product_des" id="product_des" class="form-control"> </textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button style="float: right" id="add_new_Customer" type="submit" class="btn btn-purple waves-effect waves-light">Submit</button>
                </form>
            </div>
            <!-- card-body -->
        </div>
